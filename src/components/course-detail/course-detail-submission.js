...
class CourseDetailSubmission extends React.Component {
  ...
  render() {
    const { classes, prevSolutionDetail, slug, exercises } = this.props;
    ...
    const { submissionType, submissionState } = getExerciseDetailFromSlug(
      slug,
      exercises,
    );
            ...
            <Grid container>
              ...
              <Grid item xs={6} sm={6} md={6} className={classes.floatRight}>
                ...
                {prevSolutionDetail.state !== 'pending' ? (
                  <React.Fragment>
                    <Typography variant="body2">Reviewer Feedback:</Typography>
                    <Typography variant="body1">
