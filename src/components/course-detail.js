...
class CourseDetail extends React.Component {
  ...
  updateLinks = (htmlFromServer) => {
    let courseDetail = new DOMParser().parseFromString(htmlFromServer,
      'text/html');
  ...
  async loadExercise() {
    ...
    try {
      response = (
        await fetchApi(`/courses/${id}/exercise/getBySlug`, {
          slug
        }, {
          Authorization: jwt
        })
